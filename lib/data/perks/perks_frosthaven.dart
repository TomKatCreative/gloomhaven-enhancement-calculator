...
class FrosthavenPerks {
  ...
  static final Map<String, List<Perks>> perks = {
    ...
    ClassCodes.drifter: [
      Perks([
        Perk(1, '$_replace $_one -1 $_card with $_one +1 $_card', quantity: 3),
        ...
        Perk(6, '$_add $_one +3 $_card'),
        Perk(7, '$_add $_one +2 $_immobilize $_card', quantity: 2),
        Perk(8, '$_add $_two "$_heal 1, self" $_rolling $_cards'),
        Perk(9, '$_ignoreScenarioEffectsAndAdd $_one +1 $_card'),
        Perk(10, '$_ignoreItemMinusOneEffectsAndAdd $_one +1 $_card'),
        Perk(
          11,
    ...
    ClassCodes.blinkBlade: [
      Perks([
        ...
        Perk(7, '$_add $_one -1 "Gain $_one TIME_TOKEN" $_card', quantity: 2),
        Perk(
          8,
        ...
        Perk(11, 'Whenever you would gain $_immobilize, prevent the condition'),
      ], variant: Variant.base),
    ],
    ...
    ClassCodes.bannerSpear: [
      Perks([
        ...
        Perk(3, '$_add $_one +1 $_disarm $_card', quantity: 2),
        Perk(4, '$_add $_one +2 $_push 1 $_card', quantity: 2),
        Perk(5, '$_add $_two +1 $_rolling $_cards', quantity: 2),
        Perk(6, '$_add $_two "$_heal 1, self" $_rolling $_cards', quantity: 2),
        Perk(7, '$_ignoreItemMinusOneEffectsAndRemove $_one -1 $_card'),
        Perk(
          8,
    ...
    ClassCodes.deathwalker: [
      Perks([
        ...
        Perk(5, '$_add $_one +2 $_dark $_card', quantity: 2),
        Perk(
          6,
    ...
    ClassCodes.boneshaper: [
      Perks([
        ...
        Perk(6, '$_add $_one +2 $_earth/$_dark $_card', quantity: 3),
    ...
    ClassCodes.geminate: [
      Perks([
        ...
        Perk(6, '$_add $_two +1 $_push 3 $_cards'),
        Perk(7, '$_add $_one 2x "$_brittle, self" $_card'),
        Perk(
          8,
    ...
    ClassCodes.pyroclast: [
      Perks([
        ...
        Perk(2, 'Remove one -2 card'),
        Perk(3, 'Replace one +0 card with one +1 $_wound card', quantity: 2),
        Perk(
          4,
        ...
        Perk(7, 'Add two +1 $_fire/$_earth cards', quantity: 2),
        Perk(8, 'Add two +1 $_muddle $_rolling cards'),
        Perk(9, _ignoreScenarioEffects),
        Perk(
          10,
    ...
    ClassCodes.shattersong: [
      Perks([
        ...
        Perk(3, 'Replace one -2 card with one -1 $_stun card'),
        Perk(4, 'Replace one +0 card with one +0 $_brittle card', quantity: 2),
        Perk(
          5,
        ...
        Perk(7, 'Add one +1 "Gain 1 RESONANCE" card', quantity: 3),
        Perk(8, _ignoreScenarioEffects),
        Perk(
          9,
    ...
    ClassCodes.painConduit: [
      Perks([
        ...
        Perk(3, '$_replace $_one -1 $_card with $_one +0 $_disarm $_card'),
        Perk(
          4,
          '$_replace $_one +0 $_card with $_one +1 $_fire/$_air $_card',
          quantity: 3,
        ),
        Perk(5, '$_replace $_one +0 $_card with $_one +2 $_card'),
        Perk(6, '$_replace $_three +1 $_cards with $_three +1 $_curse $_cards'),
        Perk(
          7,
    ...
    ClassCodes.snowdancer: [
      Perks([
        ...
        Perk(3, '$_add $_two +1 $_ice/$_air $_cards', quantity: 2),
        Perk(
          4,
        ...
        Perk(7, '$_wheneverYouLongRest, you may $_ice/$_air'),
        Perk(
          8,
    ...
    ClassCodes.frozenFist: [
      Perks([
        ...
        Perk(8, '$_add $_two "$_heal 1, self" $_rolling $_cards', quantity: 3),
        Perk(
          9,
    ...
    ClassCodes.hive: [
      Perks([
        Perk(1, '$_remove $_one -2 $_card and $_one +1 $_card'),
        Perk(
          2,
        ...
        Perk(4, '$_add $_one +1 "$_heal 1, self" $_card', quantity: 3),
        Perk(5, '$_add $_one +2 $_muddle $_card', quantity: 2),
        Perk(6, '$_add $_two $_poison $_rolling $_cards'),
        Perk(7, '$_add $_two $_wound $_rolling $_cards'),
        Perk(
          8,
        ...
        Perk(9, 'At the end of each of your short rests, you may TRANSFER'),
        Perk(10, 'Whenever you would gain $_wound, prevent the condition'),
      ], variant: Variant.base),
    ],
    ...
    ClassCodes.metalMosaic: [
      Perks([
        ...
        Perk(6, '$_add $_one +3 $_card'),
        Perk(7, '$_ignoreItemMinusOneEffectsAndAdd two +1 $_cards'),
        Perk(
          8,
    ...
    ClassCodes.deepwraith: [
      Perks([
        ...
        Perk(5, 'Replace two +0 cards with two $_pierce 3 $_rolling cards'),
        Perk(6, 'Replace two +1 cards with two +2 cards'),
        Perk(7, 'Replace three +1 cards with three +1 $_curse cards'),
        Perk(8, 'Add two +1 "Gain 1 TROPHY" cards', quantity: 3),
        Perk(9, '$_ignoreScenarioEffectsAndRemove two +0 cards'),
        Perk(
          10,
          '$_wheneverYouLongRest, you may $_loot one adjacent hex. If you gain any loot tokens, gain 1 TROPHY',
        ),
        Perk(11, '$_atTheStartOfEachScenario, gain 2 TROPHY'),
        Perk(
          12,
    ...
    ClassCodes.crashingTide: [
      Perks([
        ...
        Perk(5, 'Add one +2 $_muddle card', quantity: 2),
        Perk(6, 'Add one +1 $_disarm card'),
        Perk(7, 'Add two "$_heal 1, self" $_rolling cards', quantity: 2),
        Perk(
          8,
