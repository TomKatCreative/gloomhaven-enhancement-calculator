...
/// 4.0 — Minimal spacing, tight layouts
const double tinyPadding = 4.0;

/// 8.0 — Standard tight spacing
const double smallPadding = 8.0;

/// 12.0 — Standard comfortable spacing
const double mediumPadding = 12.0;

/// 16.0 — Section spacing, card padding
const double largePadding = 16.0;

/// 24.0 — Major section breaks, screen padding
const double extraLargePadding = 24.0;

// Border Radius - use these for all rounded corners

/// 4.0 — Small rounded corners (checkboxes)
const double borderRadiusSmall = 4.0;

/// 8.0 — Standard input/card corners
const double borderRadiusMedium = 8.0;

/// 16.0 — Larger rounded elements
const double borderRadiusLarge = 16.0;

/// 24.0 — Full pill shape (chips, FABs)
const double borderRadiusPill = 24.0;

/// 28.0 — Card top corners
const double borderRadiusCard = 28.0;

// Divider/Line Dimensions

/// 0.5 — Thin dividers
const double hairlineThickness = 0.5;

/// 1.0 — Standard divider line
...
/// 60.0 — Section nav chip bar height
const double chipBarHeight = 60.0;
...
/// 50.0 — Scroll-spy position tolerance
const double scrollSpyThresholdBuffer = 50.0;

// Icon Sizes - use these for all icons (never hardcode or derive sizes)

/// 14.0 — Decorative overlays (+1 badge)
const double iconSizeTiny = 14.0;
...
const double iconSizeMedium = 26.0;

/// 32.0 — Navigation, calculator, dialog buttons
const double iconSizeLarge = 32.0;

/// 36.0 — Class icons in lists/dialogs
const double iconSizeXL = 36.0;

/// 48.0 — Hero elements (level badge)
const double iconSizeHero = 48.0;
