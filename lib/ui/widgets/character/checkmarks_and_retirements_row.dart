...
///
/// JotL has no retirement mechanic (no personal quests → no retirements), so
/// only the Battle Goal Checkmarks column is shown for JotL characters.
class CheckmarksAndRetirementsRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (character.isJawsOfTheLion) {
      return _buildBattleGoals(context, charactersModel, isRetired);
    }
    ...
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: _buildPreviousRetirements(context, charactersModel, isRetired),
        ),
        ...
        Expanded(child: _buildBattleGoals(context, charactersModel, isRetired)),
      ],
    );
  }

  Widget _buildPreviousRetirements(
